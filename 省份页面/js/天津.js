    ...
    series: [
      {
        name: "",
        type: "bar",
        data: [352.15, 362, 351.4, 350.21, 339.27, 350.2, 373.48],
        barWidth: 14,
        barGap: 1,
        itemStyle: {
          normal: {
    ...
    series: [
      {
        ...
        data: [
          177.44, 178.19, 184.48, 200.4, 212.27, 209.69, 223.25, 228.18, 249.87,
          256.2,
        ],
      },

      {
        ...
        data: [8.49, 0.42, 3.53, 8.63, 5.92, -1.22, 6.47, 2.21, 9.51, 2.53],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: [10.02, 8.99, 6.61, 5.63, 5.3, 4.92, 4.82],
      },
      {
        name: "磷肥",
        type: "bar",
        ...
        data: [3.17, 2.9, 2.29, 2, 1.91, 1.88, 1.78],
      },
      {
        name: "钾肥",
        type: "bar",
        ...
        data: [1.48, 1.55, 1.48, 1.34, 1.24, 1.18, 1.16],
      },
      {
        name: "复合肥",
        type: "bar",
        ...
        data: [7.11, 8.34, 7.63, 7.98, 7.79, 7.3, 7.9],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: ["1.5", "1.54", "1.55", "1.3799", "1.3163", "1.3392", "1.3398"],
      },
      {
        name: "小型拖拉机",
        type: "line",
        ...
        data: ["0.28", "0.22", "0.18", "0.3102", "0.3606", "0.3378", "0.3441"],
      },
    ],
  };
...
(function () {
  ...
  var obj = {
    ...
    data: {
      data2: [15.33, 15.5, 14.89, 14.03, 2.2, 2.1],
      data1: [0.36, 0.35, 0.33, 0.24, 0.22, 0.22],
    },
  };
  var accountArr = [];
...
(function () {
  ...
  option = {
    ...
    series: [
      {
        name: "农用塑料薄膜消耗量",
        data: [12274, 10551.9, 11644, 10906.41, 9069.82, 8096],
        type: "line",
        symbol: "none",
        lineStyle: {
          color: "#ffd918",
