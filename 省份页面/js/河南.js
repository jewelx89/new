    ...
    series: [
      {
        ...
        type: "bar",
        data: [
          11126.3, 11219.55, 10915.13, 10906.08, 10734.54, 10738.79, 10772.31,
        ],
        barWidth: 14,
        barGap: 1,
        itemStyle: {
    ...
    series: [
      {
        ...
        data: [
          6023.8, 6133.6, 6470.22, 6498.01, 6524.25, 6648.91, 6695.36, 6825.8,
          6544.17, 6789.4,
        ],
      },

      {
        ...
        data: [2.13, 1.82, 5.49, 0.43, 0.4, 1.91, 0.7, 1.95, -4.13, 3.75],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: [238.66, 228.3, 219.98, 201.67, 190.02, 182.24, 172.64],
      },
      {
        name: "磷肥",
        type: "bar",
        ...
        data: [117.54, 113.76, 108.08, 96.35, 89.69, 85.51, 80.89],
      },
      {
        name: "钾肥",
        type: "bar",
        ...
        data: [63.58, 63.31, 58.34, 57.44, 55.26, 52.24, 50.72],
      },
      {
        name: "复合肥",
        type: "bar",
        ...
        data: [296.31, 309.65, 320.3, 337.34, 331.75, 328, 320.42],
      },
    ],
  };
...
(function () {
  ...
  var obj = {
    ...
    data: {
      // 柴油
      data2: [115.95, 114.7, 112.44, 108.84, 103.92, 100.1],
      //农药
      data1: [12.99, 12.87, 12.71, 12.07, 11.36, 10.72],
    },
  };
  var accountArr = [];
...
(function () {
  ...
  option = {
    ...
    series: [
      {
        name: "农用塑料薄膜消耗量",
        data: [163477, 162001, 163149, 157298, 152838, 150762],
        type: "line",
        symbol: "none",
        lineStyle: {
          color: "#ffd918",
