    ...
    series: [
      {
        name: "",
        type: "bar",
        data: [2403.41, 2405.28, 2295.85, 2219.63, 2203.61, 2230.19, 2371.65],
        barWidth: 14,
        barGap: 1,
        itemStyle: {
          normal: {
    ...
    series: [
      {
        ...
        data: [
          1726.95, 1749.85, 1895.32, 1552.33, 1484.73, 1504.23, 1527.07, 1583.4,
          1735.78, 1813.5,
        ],
      },

      {
        ...
        data: [
          13.8128065, 1.3260372, 8.313284, -18.0966802, -4.3547442, 1.3133701,
          1.5183848, 3.6887634, 9.6235948, 4.477526,
        ],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: [109.8, 112.63, 109.64, 109.88, 109.54, 105.18, 102.8],
      },
      {
        name: "磷肥",
        type: "bar",
        ...
        data: [66.2, 68.19, 64.88, 65.14, 64.48, 61.99, 58.24],
      },
      {
        name: "钾肥",
        type: "bar",
        ...
        data: [20.57, 20.08, 20.4, 20.86, 22.66, 22.27, 22.3],
      },
      {
        name: "复合肥",
        type: "bar",
        ...
        data: [51.52, 49.31, 55.83, 59.12, 61.08, 58.79, 57.35],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: ["47.43", "49.21", "50.87", "33.62", "36.99", "39.73", "40.66"],
      },
      {
        name: "小型拖拉机",
        type: "line",
        ...
        data: ["27.74", "26.12", "25.26", "43.20", "39.21", "36.35", "32.09"],
      },
    ],
  };
...
(function () {
  ...
  var obj = {
    ...
    data: {
      data2: [2.68, 2.58, 2.76, 2.77, 2.37, 2.29],
      data1: [80.05, 86.3, 87.78, 88.25, 95.54, 94.2],
    },
  };
  var accountArr = [];
...
(function () {
  ...
  option = {
    ...
    series: [
      {
        name: "农用塑料薄膜消耗量",
        data: [262921.1, 268901.07, 266197.5, 252646, 269839, 262677],
        type: "line",
        symbol: "none",
        lineStyle: {
          color: "#ffd918",
