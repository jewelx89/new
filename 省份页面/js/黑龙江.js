    ...
    series: [
      {
        ...
        type: "bar",
        data: [
          14283.08, 14201.81, 14154.28, 14214.54, 14338.1, 14438.38, 14551.3,
        ],
        barWidth: 14,
        barGap: 1,
        itemStyle: {
    ...
    series: [
      {
        ...
        data: [
          7055.11, 7403.8, 7615.78, 7416.13, 7410.34, 7506.8, 7503.01, 7540.78,
          7867.72, 7763.1,
        ],
      },

      {
        ...
        data: [6.92, 4.94, 2.86, -2.62, -0.08, 1.3, -0.05, 0.5, 4.34, -1.33],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: [88.46, 87.1, 85.45, 83.56, 72.97, 71.94, 75.94],
      },
      {
        name: "磷肥",
        type: "bar",
        ...
        data: [52.11, 50.7, 52.58, 49.48, 44.07, 45.03, 47.61],
      },
      {
        name: "钾肥",
        type: "bar",
        ...
        data: [37.27, 36.37, 35.62, 34.68, 30.58, 30.86, 32.37],
      },
      {
        name: "复合肥",
        type: "bar",
        ...
        data: [77.47, 78.58, 77.55, 77.92, 75.64, 76.39, 83.05],
      },
    ],
  };
...
(function () {
  ...
  var obj = {
    ...
    data: {
      // 柴油
      data2: [144.97, 145.02, 145.46, 146.82, 147.42, 137.4],
      //农药
      data1: [8.74, 8.29, 8.25, 8.32, 7.42, 6.43],
    },
  };
  var accountArr = [];
...
(function () {
  ...
  option = {
    ...
    series: [
      {
        name: "农用塑料薄膜消耗量",
        data: [84424, 83097, 82575, 79770, 77431, 71831],
        type: "line",
        symbol: "none",
        lineStyle: {
          color: "#ffd918",
