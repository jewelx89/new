    ...
    series: [
      {
        name: "",
        type: "bar",
        data: [6772.1, 6791.38, 6658.52, 6538.68, 6469.17, 6388.8, 6428.61],
        barWidth: 14,
        barGap: 1,
        itemStyle: {
          normal: {
    ...
    series: [
      {
        ...
        data: [
          3584.87, 3568.98, 3602.19, 3782.99, 3829.25, 3700.86, 3739.24,
          3795.89, 3825.09, 3865.1,
        ],
      },

      {
        ...
        data: [4.13, -0.44, 0.93, 5.02, 1.22, -3.35, 1.04, 1.52, 0.77, 1.05],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: [147.95, 144.95, 140.29, 114.47, 106.49, 100.61, 96.06],
      },
      {
        name: "磷肥",
        type: "bar",
        ...
        data: [46.36, 45.17, 43.7, 23.94, 23.37, 22.28, 22.03],
      },
      {
        name: "钾肥",
        type: "bar",
        ...
        data: [28.05, 27.73, 26.83, 23.97, 22.2, 20.99, 20.01],
      },
      {
        name: "复合肥",
        type: "bar",
        ...
        data: [113.14, 113.93, 111.17, 150.02, 145.2, 141.83, 138.78],
      },
    ],
  };
...
(function () {
  ...
  var obj = {
    ...
    data: {
      // 柴油
      data2: [291.02, 293.19, 218.65, 224.55, 217.56, 200.1],
      //农药
      data1: [8.63, 8.33, 8.17, 7.76, 6.15, 5.73],
    },
  };
  var accountArr = [];
...
(function () {
  ...
  option = {
    ...
    series: [
      {
        name: "农用塑料薄膜消耗量",
        data: [137918, 137983, 138434, 128100, 109833, 103211],
        type: "line",
        symbol: "none",
        lineStyle: {
          color: "#ffd918",
