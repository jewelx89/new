    ...
    series: [
      {
        name: "",
        type: "bar",
        data: [280.39, 284.7, 282.56, 281.26, 280.2, 290.03, 302.41],
        barWidth: 14,
        barGap: 1,
        itemStyle: {
          normal: {
    ...
    series: [
      {
        ...
        data: [
          103.55, 105.8, 104.04, 104.78, 102.55, 103.06, 105.54, 107.42, 109.09,
          107.3,
        ],
      },

      {
        ...
        data: [1.81, 2.17, -1.66, 0.71, -2.13, 0.5, 2.41, 1.78, 1.55, -1.64],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: [4.08, 3.62, 3.54, 3.45, 2.62, 2.08, 1.92],
      },
      {
        name: "磷肥",
        type: "bar",
        ...
        data: [1.77, 1.5, 1.46, 1.44, 0.95, 0.57, 0.5],
      },
      {
        name: "钾肥",
        type: "bar",
        ...
        data: [0.26, 0.18, 0.19, 0.18, 0.21, 0.15, 0.12],
      },
      {
        name: "复合肥",
        type: "bar",
        ...
        data: [4.01, 3.46, 3.48, 3.25, 2.41, 2.64, 2.34],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: ["1.69", "1.78", "1.84", "0.12", "1.3086", "1.2482", "1.3317"],
      },
      {
        name: "小型拖拉机",
        type: "line",
...
(function () {
  ...
  var obj = {
    ...
    data: {
      // 柴油
      data2: [6.56, 6.54, 6.39, 6.41, 6.44, 6.6],
      //农药
      data1: [0.19, 0.2, 0.19, 0.19, 0.18, 0.14],
    },
  };
  var accountArr = [];
...
(function () {
  ...
  option = {
    ...
    series: [
      {
        name: "农用塑料薄膜消耗量",
        data: [7045.86, 7377, 7943.9, 8415.78, 7556.34, 7780],
        type: "line",
        symbol: "none",
        lineStyle: {
          color: "#ffd918",
