    ...
    series: [
      {
        name: "",
        type: "bar",
        data: [5534.09, 5542.39, 5543.97, 5599.72, 5644.93, 5681.78, 5721.25],
        barWidth: 14,
        barGap: 1,
        itemStyle: {
          normal: {
    ...
    series: [
      {
        ...
        data: [
          3763.3, 3800.06, 3974.1, 4150.7, 4154.0, 3632.74, 3877.93, 3803.17,
          4039.24, 4080.8,
        ],
      },

      {
        ...
        data: [9.07, 0.98, 4.58, 4.44, 0.08, -12.55, 6.75, -1.93, 6.21, 1.03],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: [69.06, 66.87, 63.28, 58.39, 53.3, 50.2, 42.78],
      },
      {
        name: "磷肥",
        type: "bar",
        ...
        data: [7, 6.95, 6.54, 6.29, 5.87, 5.68, 5.03],
      },
      {
        name: "钾肥",
        type: "bar",
        ...
        data: [15.43, 15.21, 15.06, 14.01, 13.18, 12.63, 12.32],
      },
      {
        name: "复合肥",
        type: "bar",
        ...
        data: [139.75, 144.58, 146.14, 149.6, 154.71, 156.78, 162.87],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: ["52.16", "56", "58.43", "31.59", "34.1", "38.4677", "41.6799"],
      },
      {
        name: "小型拖拉机",
        type: "line",
...
(function () {
  ...
  var obj = {
    ...
    data: {
      // 柴油
      data2: [65.31, 66.68, 67.04, 67.6, 67.34, 65.7],
      //农药
      data1: [5.95, 6.23, 5.85, 5.63, 5.1, 4.87],
    },
  };
  var accountArr = [];
...
(function () {
  ...
  option = {
    ...
    series: [
      {
        name: "农用塑料薄膜消耗量",
        data: [57858, 59164, 59565, 60752, 56216, 53130],
        type: "line",
        symbol: "none",
        lineStyle: {
          color: "#ffd918",
