    ...
    series: [
      {
        name: "",
        type: "bar",
        data: [104.45, 85.54, 66.84, 55.64, 46.52, 48.9, 60.92],
        barWidth: 14,
        barGap: 1,
        itemStyle: {
          normal: {
    ...
    series: [
      {
        ...
        data: [
          96.13, 63.94, 62.64, 52.76, 41.12, 34.14, 28.76, 30.53, 37.75, 45.4,
        ],
      },

      {
        ...
        data: [
          -15.5, -33.49, -2.03, -15.77, -22.06, -16.97, -15.76, 6.15, 23.65,
          20.26,
        ],
      },
    ],
    ...
    series: [
      {
        ...
        data: [4.85, 4.39, 3.8, 3.02, 2.25, 2.17, 2.09],
      },
      {
        name: "磷肥",
        type: "bar",
        ...
        data: [0.6, 0.54, 0.47, 0.4, 0.34, 0.32, 0.31],
      },
      {
        name: "钾肥",
        type: "bar",
        ...
        data: [0.54, 0.51, 0.44, 0.39, 0.34, 0.35, 0.33],
      },
      {
        name: "复合肥",
        type: "bar",
        ...
        data: [4.54, 4.22, 3.85, 3.49, 3.25, 3.22, 3.56],
      },
    ],
  };
    ...
    series: [
      {
        ...
        data: ["0.7", "0.73", "0.69", "0.47", "0.4314", "0.413", "0.4163"],
      },
      {
        name: "小型拖拉机",
        type: "line",
        ...
        data: ["0.14", "0.13", "0.14", "0.22", "0.2124", "0.2007", "0.1855"],
      },
    ],
  };
...
(function () {
  ...
  var obj = {
    ...
    data: {
      data2: [3.36, 2.78, 2.53, 2.25, 1.93, 1.8],
      data1: [0.36, 0.32, 0.3, 0.27, 0.26, 0.23],
    },
  };
  var accountArr = [];
...
(function () {
  ...
  option = {
    ...
    series: [
      {
        name: "农用塑料薄膜消耗量",
        data: [10902.9, 10401.5, 9866.9, 8972.6, 8243.3, 7699],
        type: "line",
        symbol: "none",
        lineStyle: {
          color: "#ffd918",
